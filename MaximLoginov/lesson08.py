...
text_label = tk.Label(window, text = "Отсчёт до Нового года", font = ("Helvetica", 48), fg = "yellow", bg = "black")
countdown_label = tk.Label(window, font=("Helvetica", 48), fg = "yellow", bg = "black")
