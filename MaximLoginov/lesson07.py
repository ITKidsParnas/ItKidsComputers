...
def commandresponse(message):
    ...
    if message.text == "/start":
        bot.reply_to(message, "Приветик, запиши мне голосовое или же кружочек, а я его преобразую в текст. Или напиши мне: переведи (и через пробел своё слово на другом языке кроме русского) и я его переведу на русский")   
    if message.text == "/help":
        bot.reply_to(message, "Запиши мне голосовое или кружочек, я его преобразую в текст, Или напиши: переведи (и своё слово на другом языке кроме русского) и я переведу его на русский")       
