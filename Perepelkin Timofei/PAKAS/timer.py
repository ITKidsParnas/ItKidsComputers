...
import winsound  # Для звукового сигнала на Windows
...
class TimerApp:
    def __init__(self, root):
        ...
        self.label = tk.Label(root, text="Введите время в секундах:", font=("Helvetica", 20))
        self.label.pack()
    ...
    def start_timer(self):
        if not self.running:
            try:
                ...
                self.timer_label.config(text="Ошибка ввода: " + str(e))
    ...
    def update_timer(self):
        if self.running and self.time_left > 0:
            ...
            self.running = False
            winsound.Beep(1000, 1000)  # Звуковой сигнал (только для Windows)
