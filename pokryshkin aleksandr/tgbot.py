...
import telebot
import translate
bot = telebot.TeleBot("7945677860:AAFVa3CDejo3UNQa3Jpvr0FZ0BeAVXBmlxE",parse_mode=None)
language = 'ru_RU'
r = sr.Recognizer()
...
def command_response(message):
    ...
    if message.text == "/start":
        ...
        bot.reply_to(message, "привет,я Gbot перешли мне голосовое и я его расшифрую")
