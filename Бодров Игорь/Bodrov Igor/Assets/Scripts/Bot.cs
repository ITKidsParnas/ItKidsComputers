...
public class Bot : MonoBehaviour
{
    ...
    {
        if (collision.gameObject.GetComponent<FirstPersonMovement>() != null) { SceneManager.LoadScene(SceneManager.GetActiveScene().name);}
    }
    private void OnTriggerEnter(Collider other)
    {
       var player = other.gameObject.GetComponent<FirstPersonMovement>();
        if (player != null)
        {
